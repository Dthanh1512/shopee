...
function FloatingFocusManager(_ref) {
  ...
  index(() => {
    ...
    return () => {
      events.off('dismiss', onDismiss);
      const shouldFocusReference = contains(floating, activeElement(doc)) || contextData.openEvent && ['click', 'mousedown'].includes(contextData.openEvent.type);
  ...
  }, [open, floating, getTabbableElements, returnFocusRef, initialFocusRef, dataRef, refs, events, ignoreInitialFocus]);
